...
**必讀設計**：[`design/rules/definitions.md`](../../../design/rules/definitions.md)（整份，這是本任務的核心）、
[`design/maps/worldmap.md`](../../../design/maps/worldmap.md) 的「Tile 資料佈局：SoA」、
[`design/architecture/zone-save-format.md`](../../../design/architecture/zone-save-format.md) 的「存字串 id，不存下標」
...
照 [`definitions.md`](../../../design/rules/definitions.md) 的「形狀」一節。M1.0 只做
...
- **下標即 id**：`enum class TerrainId : uint16_t {}`——**枚舉子一個都不准列**。
  這是本專案最容易被違反的一條，見 [`cpp-conventions.md`](../../../design/architecture/cpp-conventions.md)。
...
照 [`worldmap.md`](../../../design/maps/worldmap.md) 的 SoA。邊資料打平成 `idx*4+dir`，
...
照 [`zone-save-format.md`](../../../design/architecture/zone-save-format.md)：
