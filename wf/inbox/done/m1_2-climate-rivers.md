...
**必讀設計**：[`design/generation/worldgen-terrain.md`](../../../design/generation/worldgen-terrain.md) 第 4～7 階段、
[`design/architecture/zone-save.md`](../../../design/architecture/zone-save.md) 的「⚠ 生成參數也要固定進 manifest」（新增）
**基準**：`94e50fe`
...
已寫進 [`design/architecture/zone-save.md`](../../../design/architecture/zone-save.md)。
