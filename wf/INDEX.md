...
| 路徑 | 內容 |
|------|------|
| [common/README](workflows/common/README.md) | 跨工作流共通：[gotchas](workflows/common/gotchas.md) 踩坑 + [conventions](workflows/common/conventions.md) 程式碼慣例（架構鐵律：核心 C++ 不依賴 godot-cpp、Godot 端不持有玩法狀態）|
