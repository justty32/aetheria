...
> [本層入口](README.md)｜承接 [interface-world-mid.md](interface-world-mid.md)。
...
> （見 [zone-save-format.md](../architecture/zone-save-format.md)），程序層本來就不在裡面。
...
> 「L2↔L3 沿用同一套機制的差異點」→ [lowmap.md](../maps/lowmap.md)。
