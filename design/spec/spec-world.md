...
勢力打算、軍隊調度、城區發展與人物取捨，另按 [行為核對](spec-behavior-review.md) 查看理由、替代選擇及跨層後果。一般數值與罕見例外保留彈性。2026-09-10 已按原要求完成 [整體審閱](spec-world-review.md)，逐項列正文證據；結論是本批世界與 NPC 運作規劃已具備，不是實作或校準通過。
