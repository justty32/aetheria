...
← [本層入口](README.md)｜[收斂主線](../overview/spec-world-core.md)
...
最新使用者方向在 [規劃尺度](../overview/spec-planning-scope.md)：先有三層世界與 NPC 自主行為，再讓使用者提供人物的決策；世界與人物分檔、同世界多人物已定。普通任務用 sol，簡單整理用 terra／luna，對話與文件用繁體中文、大白話。
