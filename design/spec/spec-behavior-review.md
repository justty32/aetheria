...
這條鏈把 [家庭](people/spec-family-formation.md)、[政體](spec-government.md)、[旅行](economy/spec-travel.md) 與共用等待規則放在一起。文件推演未發現必須新增中央決策者的缺口；找到的是旅行篇「保留當前安全狀態」容易把受阻當安全，已改為保留實際位置，暴露與消耗仍推進。後續執行驗證應另比中途換層、讀檔及遲到通知，不能用本表宣稱已通過。
